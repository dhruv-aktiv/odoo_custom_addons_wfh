...
class Clg_Student(models.Model):
    ...
    name = fields.Char(string='Student Name',
                       default="your name")
    mobile_no = fields.Char(string='Student Mo No.',tracking=True)
    ...
    def create(self, vals):
        ...
        default_name = super(Clg_Student, self).default_get(['name'])
        print(f"\n\n\n {default_name} \n\n\n")
        vals.update({
    ...
    #     for rec in self:
    #         if not rec.mobile_no:
    #                 raise ValidationError("Please enter mobile no.")
    ...
    def default_get(self, fields=[]):
        res = super(Clg_Student, self).default_get(fields)
        # print(res['res_id'])
        # print(f"\n\n\n {res} \n\n\n")
        # print(f"\n\n\n {res['name']} \n\n\n")
        # print(res['name'])
        ...
        # record = super(Clg_Student, self).create({
        #     'name' : val
        #     })
